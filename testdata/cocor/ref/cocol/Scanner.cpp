...
void Scanner::Init() {
	...
	keywords.set(L"COMPILER", 4);
	keywords.set(L"END", 5);
	keywords.set(L"CHARACTERS", 7);
	keywords.set(L"ANY", 12);
	keywords.set(L"CHR", 13);
	keywords.set(L"IGNORE", 16);
	keywords.set(L"TOKENS", 17);
	keywords.set(L"CONTEXT", 19);
...
Token* Scanner::NextToken() {
	...
	switch (state) {
		...
		case 3:
			case_3:
			if (ch <= 9 || (ch >= 11 && ch <= 12) || (ch >= 14 && ch <= L'&') || (ch >= L'(' && ch <= 65535)) {AddCh(); goto case_3;}
