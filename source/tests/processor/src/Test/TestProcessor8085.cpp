...
class Processor8085Test : public UnitTestCpp::TestFixture
{
public:
	virtual void SetUp();
...
void Processor8085Test::SetUp()
{
}

void Processor8085Test::TearDown()
{
}

TEST_FIXTURE(Processor8085Test, Construct)
{
    Processor8085 processor;
...
TEST_FIXTURE(Processor8085Test, DisassembleInstructionMOVDirect8)
{
    Processor8085 processor;
...
TEST_FIXTURE(Processor8085Test, DisassembleInstructionMOVDirect16)
{
    Processor8085 processor;
