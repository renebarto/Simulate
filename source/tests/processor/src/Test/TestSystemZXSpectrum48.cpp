...
class SystemZXSpectrum48Test : public UnitTestCpp::TestFixture
{
public:
	virtual void SetUp();
...
void SystemZXSpectrum48Test::SetUp()
{
}

void SystemZXSpectrum48Test::TearDown()
{
}

TEST_FIXTURE(SystemZXSpectrum48Test, Construct)
{
    //SystemZXSpectrum48 processor;
...
TEST_FIXTURE(SystemZXSpectrum48Test, DisassembleInstructionMOVDirect8)
{
    //SystemZXSpectrum48 processor;
...
TEST_FIXTURE(SystemZXSpectrum48Test, DisassembleInstructionMOVDirect16)
{
    //SystemZXSpectrum48 processor;
