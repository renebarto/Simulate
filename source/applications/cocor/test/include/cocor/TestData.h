...
public:
    ...
    static std::string TestDirectoryCocorOutput() { return Core::Path::InsertPathSeparator(Core::Path::CombinePath(TestDirectoryCocor(), "assembler"), ""); }
    ...
    static std::string TestTraceOut() { return Core::Path::CombinePath(TestDirectoryCocorAssembler(), TestTraceFileName()); }
